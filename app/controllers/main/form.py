...
class ConsultaSiteForm(FlaskForm):
    consulta = StringField('Consulta', validators=[DataRequired(message='Campo obrigatório')])
    selection = SelectField(choices=['Site', 'Cidade', 'Cep'])
